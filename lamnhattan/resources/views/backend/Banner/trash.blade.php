    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="d-flex justify-content-end">
          <div class="">
            <a class=" btn btn-sm btn-primary"  href="{{ route('brand.index') }}"><i class="fas fa-undo-alt"></i>Trở lại</a>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a class="btn btn-primary" href="{{ route('brand.restore',['brand'=>$brand->id]) }}"><i class="fa fa-undo-alt"></i></a>
